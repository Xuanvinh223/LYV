...
namespace LYV.BusinessTrip.UCO
{
    public  class BusinessTripUCO
    {
        ...
        public void InsertBusinessTripFormData(string LYV, string Area, string MaPhieu,string EmployeeType, string DepID, string UserID, XElement xE)
        {
            m_BusinessTripPO.InsertBusinessTripFormData(LYV, Area, MaPhieu, EmployeeType, DepID, UserID, xE);
        }
        public void UpdateFormStatus(string LYV, string Area, string MaPhieu,string EmployeeType, string SiteCode, string signStatus, XElement xE)
        {
            m_BusinessTripPO.UpdateFormStatus(LYV, Area, MaPhieu, EmployeeType, SiteCode, signStatus, xE);
        }
