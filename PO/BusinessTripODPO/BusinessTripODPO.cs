...
namespace LYV.BusinessTripOD.PO
{
    internal class BusinessTripODPO : Ede.Uof.Utility.Data.BasePersistentObject
    {
        ...
        internal void InsertBusinessTripODFormData(string id, string EmployeeType, string RequestDate, string Type, string DepID, string UserID, XElement xE)
        {
            string conn = LYV.Properties.Settings.Default.UOF.ToString();
            this.m_db = new Ede.Uof.Utility.Data.DatabaseHelper(conn);
        ...
        internal void UpdateFormStatus(string id, string EmployeeType, string RequestDate, string Type, string DepID, string UserID, string SiteCode, string signStatus, XElement xE)
        {
            string conn = LYV.Properties.Settings.Default.UOF.ToString();
            this.m_db = new Ede.Uof.Utility.Data.DatabaseHelper(conn);
        ...
        internal DataTable GetListBT(string id, string Name, string Name_ID, string Time1, string Time2)
        {
            string conn = LYV.Properties.Settings.Default.UOF.ToString();
            this.m_db = new Ede.Uof.Utility.Data.DatabaseHelper(conn);
            string where = "";
